...
| `manuals/` | Committed typeset builds of the four-volume manual suite (owner-instructed, 2026-09-18) — generated by `scripts/build_manual.py`, provenance in `manuals/MANIFEST.md` per Rule 26; regenerated wholesale, never hand-edited | Regenerated — a rebuild replaces all four PDFs + manifest in one commit | Exactly four PDFs + `MANIFEST.md` |
