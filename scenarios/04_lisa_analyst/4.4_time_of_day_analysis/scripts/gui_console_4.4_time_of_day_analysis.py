# GUI scripting-window script — Scenario 4.4: Time-of-day analysis — 300 K, emissivity 0.9 pixel
#
# HOW TO USE
#   1. In the RADIANT GUI: File -> Open YAML -> inputs/4.4_time_of_day_analysis.gui.yaml
...
# (headless smoke test): python scripts/gui_console_4.4_time_of_day_analysis.py
...
print("=== Scenario 4.4: Time-of-day analysis — 300 K, emissivity 0.9 pixel ===")
...
def _sweep_and_plot():
    ...
    ax.set_ylabel("SNR [-]")
    ax.set_title("Scenario 4.4: SNR vs aperture diameter")
    ax.grid(alpha=0.3)
    return fig
