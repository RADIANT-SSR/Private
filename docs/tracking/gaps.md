...
| **Status** | DELIVERED 2026-09-05 (`ca6b4f3e`, v1 — plan Phases 0–2: schema + validation, counting-well/quantization physics, live chain dispatch, counting noise budget, D2 DN semantics, HDR dynamic range, scenario 2.6 DROIC-vs-analog). Remaining plan phases: 3 (GUI panel) and 4 (up/down counting, v1.1) — plan stays Active. |
...
| **Status** | OPEN — plan drafting in progress (`docs/plans/FPA_Preset_Library_Plan.md`, Draft for owner ratification). |
