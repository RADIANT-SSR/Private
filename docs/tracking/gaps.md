...
| **Status** | OPEN — plan ratified by the owner 2026-09-06 (`docs/plans/Calibration_Model_Plan.md`, Active; D1–D7 adopted as recommended). Phase 0 delivered 2026-09-06: `CalibrationStage` skeleton in the chain (10 stages), `calibration.*` schema, `BiasTerm`/`with_bias` accumulator, `CALIBRATION_TERMS`; `scheme=none` no-op, goldens bit-identical. Phase 1 (physics) next. |
