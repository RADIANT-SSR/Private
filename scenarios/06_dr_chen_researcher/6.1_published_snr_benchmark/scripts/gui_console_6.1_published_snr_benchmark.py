# GUI scripting-window script — Scenario 6.1: Published SNR benchmark — datasheet sensor
#
# HOW TO USE
#   1. In the RADIANT GUI: File -> Open YAML -> inputs/6.1_published_snr_benchmark.gui.yaml
...
# (headless smoke test): python scripts/gui_console_6.1_published_snr_benchmark.py
...
print("=== Scenario 6.1: Published SNR benchmark — datasheet sensor ===")
...
def _sweep_and_plot():
    ...
    ax.set_ylabel("SNR [-]")
    ax.set_title("Scenario 6.1: SNR vs aperture diameter")
    ax.grid(alpha=0.3)
    return fig
