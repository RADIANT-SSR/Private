...
|---|---|---|---|---|---|---|
| T1 | 10 km | 0.25 m | 1.00 (resolved) | 371 806 | 547.6 | 1.000 |
| T2 | 20 km | 0.50 m | 1.00 (resolved) | 271 047 | 399.4 | 1.000 |
| T3 | 50 km | 1.25 m | 1.00 (resolved) | 205 060 | 302.2 | 1.000 |
| T4 | 100 km | 2.50 m | 1.00 (resolved) | 169 256 | 249.3 | 1.000 |
| T5 | 200 km | 5.00 m | 0.36 (sub-pixel) | 40 251 | 59.3 | 1.000 |

Background pixel: 4.503×10⁵ e-, σ = 679 e- — **shot-noise-limited**. Every
nominal target is 15–40 K hotter than the background, so contrast SNR runs
59–548. **All five are trivially detected** — the correct answer for a hot,
...
| Range | GSD | Fill frac | Contrast (e-) | Contrast SNR | P_d @ P_fa 1e-4 |
|---|---|---|---|---|---|
| 200 km | 5.0 m | 0.360 | 40 251 | 59.3 | 1.000 |
| 500 km | 12.5 m | 0.0576 | 6 440 | 9.5 | 1.000 |
| 800 km | 20.0 m | 0.0225 | 2 516 | 3.7 | **0.495** |
| 1100 km | 27.5 m | 0.0119 | 1 331 | 2.0 | 0.039 |
| 1300 km | 32.5 m | 0.0085 | 953 | 1.4 | 0.010 |
| 1500 km | 37.5 m | 0.0064 | 716 | 1.05 | 0.004 |
| 2000 km | 50.0 m | 0.0036 | 403 | 0.59 | 0.001 |

- **Reliable detection (P_d ≥ 0.9 @ P_fa 1e-4) holds out to ≈ 549 km**;
  the **50/50 range is ≈ 796 km**. Between them is the operating band where
  a detection algorithm actually earns its keep.
- Note the gap between AUC and the strict-P_fa `P_d`: at 800 km the AUC is
  still 0.996 (excellent *separation*) but `P_d` at P_fa = 1e-4 is only 0.49.
