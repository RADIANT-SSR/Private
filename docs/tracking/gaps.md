...
| **Status** | OPEN — plan ratified by the owner 2026-09-06 (`docs/plans/Calibration_Model_Plan.md`, Active; D1–D7 adopted as recommended). Phases 0–1 delivered 2026-09-06: chain skeleton + schema + `BiasTerm` accumulator (P0); NUC-residual/cal-point/drift/cal-source-bias physics modules, Level-0 anchored, + D2 detector handoff (P1). Stage dispatch still gated. Phase 2 (chain + accuracy metric) next. |
