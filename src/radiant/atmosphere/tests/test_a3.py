...
class TestAnchor3HandCalculatedOD:
    ...
    def test_backend_tau_up_matches_hand_calc_at_4um(self) -> None:
        ...
        integrals; the CU-161 well-mixed floor is 0.4494 × col_mol/8 km
        ...
        # mol+aer is the well-mixed floor (0.4494 · col_mol/8 km) plus a
        # tiny water term for the near-dry 10–100 km water column
        # (w_eff = 1.4 · col_h2o/2 km ≈ 0.009 cm → OD ≈ 2e-3).
        od_gas = 0.4494 * (col_mol_km / (H_MOL_M / 1000.0))
