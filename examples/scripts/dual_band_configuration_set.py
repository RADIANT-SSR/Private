...
def print_physics_discussion(study: ConfigurationSet, run: ConfigSetRunResult) -> None:
    ...
    print("  cut off below Nyquist, so there is nothing to alias. Its printed")
    print("  alias_fraction_at_nyquist of 0.944 is float noise divided by float")
    print("  noise (0/0 at the 1e-16 level), not a physical aliasing fraction;")
    print("  read the absolute folded value for an oversampled band.")
    print()
