...
Every exception the platform package raises on purpose derives from
...
__all__ = ["PlatformValidationError"]


class PlatformValidationError(RadiantError, ValueError):
    """A ``radiant.platform`` computation rejected an input value or argument."""
