...
# Disc fill color: a slightly brighter amber than ``SOLAR_FAMILY`` so the disc body
# stands out from the rays in the rendered icon (see ``palette.SUN_DISC_FILL``).
_DISC_FILL_COLOR = palette.SUN_DISC_FILL
