...
## Hard constraints (C1–C8 from docs/archive/Geometry_GUI_v2_Plan.md §3)
...
Decision D5 (docs/archive/Geometry_GUI_v2_Plan.md §16) commits to lifting `scene/` cleanly into
