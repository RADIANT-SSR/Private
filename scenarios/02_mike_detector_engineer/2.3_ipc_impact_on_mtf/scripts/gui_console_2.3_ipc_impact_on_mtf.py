# GUI scripting-window script — Scenario 2.3: IPC impact on MTF — 2% IPC baseline
#
# HOW TO USE
#   1. In the RADIANT GUI: File -> Open YAML -> inputs/2.3_ipc_impact_on_mtf.gui.yaml
...
# (headless smoke test): python scripts/gui_console_2.3_ipc_impact_on_mtf.py
...
print("=== Scenario 2.3: IPC impact on MTF — 2% IPC baseline ===")
...
def _sweep_and_plot():
    ...
    ax.set_ylabel("SNR [-]")
    ax.set_title("Scenario 2.3: SNR vs aperture diameter")
    ax.grid(alpha=0.3)
    return fig
