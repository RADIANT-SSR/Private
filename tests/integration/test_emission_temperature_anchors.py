...
_ANCHORS: dict[str, tuple[str, str, float, float, float, float, float, float, float]] = {
    ...
    "H1": ("lower", "us_standard", 0.0, 1.0e5, 0.0, 0.25659, 1.24809, 0.624, 1.189),  # 1.006 1.530
    "H4": ("lower", "tropical", 0.0, 1.0e5, 48.2, 0.58099, 5.31164, 0.754, 1.080),  # 1.046 1.226
    "H5": (
        "lower",
        "midlat_summer",
        0.0,
...
def test_lwir_parity_improves_or_holds_on_every_anchor() -> None:
    ...
    0.2611 after** — a 22 % improvement.  Honest accounting of where it does
    ...
    assert rms_post == pytest.approx(0.2611, abs=0.002)
