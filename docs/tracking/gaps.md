...
| **Status** | IN PROGRESS — plan Active (owner-ratified 2026-09-06); Phases 0–2 + 4 delivered 2026-09-06 (21 presets, 22 reference PDFs, generated configs, `fpa:`/`apply_fpa` semantics, counting-chain + H2RG goldens). Remaining: Phase 3 GUI part selector (live-review gated). |
