...
**Current file count:** 607 `.py` files under `src/radiant/` (335 source +
230 test + 42 `__init__.py`), plus 41 integration tests under
...
### `calibration/` — 11 source + 10 tests
...
├── spectral_cal.py      # band-center uncertainty → scene-vs-cal bias (Gap 122 item 3)
