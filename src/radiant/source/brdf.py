"""BRDF models for reflected-solar radiance computation.

Implements Lambertian and Phong BRDF models per
RADIANT_Source_Target_System.md §3.3.

Both models satisfy energy conservation: ``∫ BRDF · cos θ dΩ ≤ ρ``.
