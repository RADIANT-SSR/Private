# RADIANT Use-Case Coverage — Adversarial Gap Audit (pre-Option-C archive)

> **Archived 2026-04-21.** This is the 2026-04-19 adversarial audit plus its 2026-04-20 overlay, captured just **before and after** Option C landed. It is preserved verbatim as the authoritative record of what was broken, what was refactored, and why. For the current state of use-case coverage, see [`../Use_Case_gaps.md`](../Use_Case_gaps.md).
