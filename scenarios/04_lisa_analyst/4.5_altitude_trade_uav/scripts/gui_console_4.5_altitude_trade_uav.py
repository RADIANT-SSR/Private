# GUI scripting-window script — Scenario 4.5: UAV altitude trade — 2000 m reference altitude
#
# HOW TO USE
#   1. In the RADIANT GUI: File -> Open YAML -> inputs/4.5_altitude_trade_uav.gui.yaml
...
# (headless smoke test): python scripts/gui_console_4.5_altitude_trade_uav.py
...
print("=== Scenario 4.5: UAV altitude trade — 2000 m reference altitude ===")
...
def _sweep_and_plot():
    center = 0.035  # current Aperture diameter [m]
    ...
    ax.set_ylabel("SNR [-]")
    ax.set_title("Scenario 4.5: SNR vs aperture diameter")
    ax.grid(alpha=0.3)
    return fig
